                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="employee_delete.php?id=<?= $emp['id'] ?>" class="btn-icon-action btn-delete" title="Delete" onclick="return confirm('Are you sure you want to delete this employee?')">
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
